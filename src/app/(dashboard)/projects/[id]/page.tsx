        ...
        {timelinePct !== null && (
          <div className="mt-5 pt-4 border-t border-gray-50">
            ...
            <div className="relative w-full bg-gray-100 rounded-full h-2">
              ...
              {/* Progress marker */}
              <div className="absolute top-0 h-2 rounded-full bg-[#C9A96E]/60"
            ...
            <div className="flex justify-between text-xs text-gray-400 mt-1">
              ...
              <span className="text-xs text-gray-400">
                ...
                <span className="inline-flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#C9A96E]/60 inline-block" />Progress</span>
              </span>
      ...
      {invoices && invoices.length > 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 p-5 mb-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/invoices" className="text-xs text-[#C9A96E] font-semibold hover:underline">View all →</Link>
          </div>
                  ...
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-start gap-3">
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 text-xs font-bold
                        ${phase.status === 'completed' ? 'bg-green-100 text-green-600' : 'bg-[#0D1F3C]/5 text-[#0D1F3C]/40'}`}>
