  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          href="/clients/new"
          className="flex items-center gap-2 bg-[#C9A96E] hover:bg-[#b8924d] text-white font-semibold px-4 py-2.5 rounded-lg text-sm transition-colors"
        >
          <Plus size={16} />
          Add Client
        </Link>
      ...
      {!clients || clients.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
          {clients.map((client) => {
            const projectCount =
              (client.projects as unknown as { count: number }[])?.[0]?.count ?? 0
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-1.5 bg-[#0D1F3C]/5 rounded-lg px-2.5 py-1">
