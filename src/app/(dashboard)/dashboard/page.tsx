      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
        ...
        <div className="lg:col-span-3 bg-white rounded-2xl border border-gray-100 overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-50 flex items-center justify-between">
            ...
            <Link href="/projects" className="text-xs font-semibold text-[#C9A96E] hover:text-[#b8924d] flex items-center gap-1">
      ...
      <div className="mt-5 bg-white rounded-2xl border border-gray-100 p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            <Link key={label} href={href}
              className="flex flex-col items-center gap-2 p-4 rounded-xl border border-gray-100 hover:border-[#C9A96E]/40 hover:bg-[#C9A96E]/5 transition-all text-center">
